  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <section className="relative border-y border-[var(--bridge-border)] bg-[var(--bridge-canvas)]/92 py-5 backdrop-blur-xl">
        <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_80%_at_50%_-20%,color-mix(in srgb, var(--color-primary) 8%, transparent),transparent_62%)]" />
